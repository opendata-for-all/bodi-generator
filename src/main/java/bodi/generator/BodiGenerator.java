...
public final class BodiGenerator {
    ...
    public static void createBot(Configuration conf, DataSchema ds) {
        ...
        try {
            ...
            botFiles.add(outputFolder + "/src/main/java/com/xatkit/bot/customQuery/FrequentValueInField.java");
            botFiles.add(outputFolder + "/src/main/java/com/xatkit/bot/customQuery/CustomQuery.java");
            botFiles.add(outputFolder + "/src/main/java/com/xatkit/bot/customQuery/RowCount.java");
            botFiles.add(outputFolder + "/src/main/java/com/xatkit/bot/customQuery/SelectFieldsWithConditions.java");
            botFiles.add(outputFolder + "/src/main/java/com/xatkit/bot/customQuery/ShowFieldDistinct.java");
            botFiles.add(outputFolder + "/src/main/java/com/xatkit/bot/customQuery/Value1vsValue2.java");
            botFiles.add(outputFolder + "/src/main/java/com/xatkit/bot/customQuery/ValueFrequency.java");
